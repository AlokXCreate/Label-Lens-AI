  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200/80 dark:border-slate-800 shadow-md overflow-hidden transition-colors">
      ...
      <div className="p-4 sm:p-5 border-b border-slate-100 dark:border-slate-800 bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 text-white flex flex-wrap items-center justify-between gap-3">
        ...
        {/* Preset Quick Loaders for Demonstrations */}
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          <button
            ...
            className="text-xs px-2.5 py-1.5 rounded-xl bg-emerald-500/20 text-emerald-300 hover:bg-emerald-500/30 font-bold border border-emerald-500/30 flex items-center gap-1.5 transition active:scale-95 shadow-xs"
            title="Load Compliant Whole Wheat Atta Pack (100/100)"
          >
            <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
            <span>Compliant Pack</span>
          </button>
          <button
            onClick={() => loadPreset('non_compliant')}
            className="text-xs px-2.5 py-1.5 rounded-xl bg-amber-500/20 text-amber-300 hover:bg-amber-500/30 font-bold border border-amber-500/30 flex items-center gap-1.5 transition active:scale-95 shadow-xs"
          ...
          <button
            ...
            className="text-xs px-2.5 py-1.5 rounded-xl bg-rose-500/20 text-rose-300 hover:bg-rose-500/30 font-bold border border-rose-500/30 flex items-center gap-1.5 transition active:scale-95 shadow-xs"
            title="Load Imported Chocolate Missing Indian MRP / Declarations"
          >
            <XCircle className="w-3.5 h-3.5 text-rose-400" />
            <span>Foreign Import</span>
          </button>
          <button
            onClick={() => loadPreset('unlicensed')}
            className="text-xs px-2.5 py-1.5 rounded-xl bg-purple-500/20 text-purple-300 hover:bg-purple-500/30 font-bold border border-purple-500/30 flex items-center gap-1.5 transition active:scale-95 shadow-xs"
            title="Load Underfilled Potato Chips Pack (Violates First Schedule MPE)"
          >
            <Eye className="w-3.5 h-3.5 text-purple-400" />
            <span>Underfilled Pack</span>
          </button>
        </div>
      </div>
              ...
              <div className="flex flex-col items-center justify-center p-6 text-center text-slate-400">
                <div className="flex items-center gap-3 mb-4">
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl bg-brand-600 hover:bg-brand-700 text-white font-bold text-xs flex items-center gap-2 shadow-lg shadow-brand-500/25 transition active:scale-95"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-xs flex items-center gap-2 border border-slate-700 transition active:scale-95"
                  >
