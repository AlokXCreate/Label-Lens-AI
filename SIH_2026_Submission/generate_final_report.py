# Final Perfect 10-Page SIH 2026 Detailed Project Report Generator
import os, sys, subprocess, base64, pymupdf
...
print('Loaded all 6 image assets.')
...
report_css = """
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; }
  body { color: #1E293B; background: #FFFFFF; font-size: 10.5px; line-height: 1.45; }
  ...
  .header-title h1 { font-size: 20px; font-weight: 900; color: #0F172A; letter-spacing: -0.5px; }
  .header-title p { font-size: 10px; color: #64748B; font-weight: 600; margin-top: 2px; }
  .sih-badge-img { height: 46px; width: auto; }

  /* Mini Header (Pages 2-10) */
  .sub-header {
  ...
  .sub-header-brand { color: #0072CE; font-weight: 800; }
  ...
  p { margin-bottom: 5px; color: #334155; text-align: justify; }
  ul { margin-left: 15px; margin-bottom: 5px; }
  li { margin-bottom: 2.5px; color: #334155; }
  ...
  .card p { font-size: 10px; margin-bottom: 0; line-height: 1.38; }
  .card ul { margin-left: 12px; margin-bottom: 0; }
  .card li { font-size: 10px; margin-bottom: 1.5px; }
  ...
  <div class="report-page">
    <div class="page-body">
      ...
      <div class="callout callout-green">
        <strong>Verified Prototype Status:</strong> Label Lens AI is not a theoretical proposal. A fully functional, responsive Progressive Web App (React 19) and a compiled native Android APK (v1.1.0) are already built, tested across 50+ packaged commodities, and deployed live with zero pending defects.
      </div>

      <div class="sub-title">System Mission & Scope</div>
      <p>
        Label Lens AI bridges the gap between complex legal metrology statutes and rapid ground-level execution. By turning consumer smartphones and field officer terminals into intelligent statutory scanners, the platform safeguards consumer rights, ensures fair market competition for compliant brands, and establishes an objective, tamper-proof electronic audit trail.
      </p>
    </div>
    ...
    <div class="doc-footer">
      ...
      <div>Page 1 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""
  ...
  <div class="report-page">
    <div class="page-body">
      ...
      <div class="sub-header">
        <span class="sub-header-brand">LABEL LENS AI</span>
        <span>Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</span>
      </div>
      ...
      <ul>
        <li><strong>Multi-Panel PDP Image Capture:</strong> Captures multi-angle photographs of pre-packaged commodities (front, back, sides) and programmatically calculates Principal Display Panel (PDP) surface area (A = H × W for rectangular packages, or 40% × H × C for cylindrical bottles under Rule 2(h)).</li>
        ...
        <li><strong>Deterministic Statutory Rules Adjudication:</strong> Programmatically validates numeral heights against <strong>PCR Table-I</strong>, performs an algorithmic <strong>Modulo-11 checksum on 14-digit FSSAI licenses</strong>, mathematically verifies Unit Sale Price (USP = MRP / Net Quantity), and checks expiry chronology.</li>
        <li><strong>1-Click Multi-Channel Grievance Transmission:</strong> When statutory breaches are detected, the system auto-compiles court-admissible legal petitions and transmits them directly to FSSAI (compliance@fssai.gov.in), FoSCoS, National Consumer Helpline (NCH 1915), and CPGRAMS.</li>
      </ul>

      <div class="sub-title">2.2 How it Addresses the Problem</div>
      <ul>
        <li><strong>Speed Acceleration:</strong> Slashes inspection duration from 25 minutes down to <strong>3.2 seconds</strong> per package.</li>
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 2 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""

print('CSS, Page 1, and Page 2 defined.')
...
page3_html = f"""
  <div class="report-page">
    <div class="page-body">
      ...
      <!-- SECTION 3 Part 1 -->
      <div class="sec-title"><span class="sec-icon">⚙️</span> 3. Technical Approach — Technologies Used</div>
      <p>
      ...
      <div class="sub-title">System Technical Specifications & Hardware Compatibility</div>
      <table>
        <thead>
          <tr>
            <th>Architecture Layer</th>
            <th>Primary Technology</th>
            <th>Deployment & Performance Target</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td>PWA deployed on GitHub Pages; sub-second initial load; offline service worker caching.</td>
          </tr>
          <tr>
            <td><strong>Android Mobile App</strong></td>
            <td>Capacitor 8 Native Bridge</td>
            <td>Compiled 5.2 MB APK; supports Android 7.0 (API 24) to Android 15; zero external dependencies.</td>
          </tr>
          <tr>
            <td><strong>Multimodal Vision AI</strong></td>
            <td>Google Gemini 2.5 Flash</td>
            <td>Sub-2-second inference latency; normalized bounding-box coordinates; validated JSON schemas.</td>
          </tr>
          <tr>
            <td><strong>Evidence Integrity</strong></td>
            <td>W3C Web Cryptography API</td>
            <td>Client-side SHA-256 cryptographic image hashing; admissible under Section 65B Evidence Act.</td>
          </tr>
          <tr>
            <td><strong>Linguistic Inclusion</strong></td>
            <td>Web Speech API + Custom Dictionaries</td>
            <td>10 Indian regional languages (Hindi, Marathi, Bengali, Tamil, Telugu, Gujarati, Kannada, etc.).</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 3 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""
...
page4_html = f"""
  <div class="report-page">
    <div class="page-body">
      ...
      <!-- SECTION 3 Part 2 -->
      <div class="sec-title"><span class="sec-icon">🏛️</span> 3. Technical Approach — System Architecture Topology</div>
      <p>
        The Label Lens AI architecture is structured across four decoupled, high-performance tiers to guarantee security, modularity, and rapid field deployment:
      </p>

      <div class="figure-box">
        <img src="{arch_diagram}" alt="System Architecture Diagram" />
        <div class="figure-caption">Figure 3.1: End-to-End System Architecture — Ingestion, Vision Multimodal AI, Legal Rules Engine, and Redressal Gateway</div>
      </div>

      <div class="card-grid-2">
        <div class="card">
          <div class="card-head"><span>🌐</span> Tier 1: Client & Ingestion Layer</div>
          <p>Multi-angle camera ingestion across progressive web application and native Android runtime. Incorporates HTML5 Canvas optical normalization, specular glare suppression, and automatic Principal Display Panel (PDP) surface area calibration.</p>
        </div>

        <div class="card">
          <div class="card-head"><span>🧠</span> Tier 2: Vision & Multimodal AI Layer</div>
          <p>Powered by Google Gemini 2.5 Flash Multimodal Vision API. Analyzes visual and textual features simultaneously, returning spatial bounding boxes and zero-shot emblem classifications into strictly validated JSON schemas.</p>
        </div>

        <div class="card">
          <div class="card-head"><span>⚖️</span> Tier 3: Deterministic Legal Engine</div>
          <p>Executes transparent, deterministic statutory checks against Table-I font matrices, computes Modulo-11 FSSAI license checksums, evaluates Unit Sale Price formulas, and calculates Section 36 pecuniary compounding liabilities.</p>
        </div>

        <div class="card">
          <div class="card-head"><span>📨</span> Tier 4: Government Redressal Gateway</div>
          <p>Generates court-admissible electronic petitions sealed with SHA-256 cryptographic hashes. Dispatches formal complaints directly to FSSAI (compliance@fssai.gov.in), FoSCoS, National Consumer Helpline (NCH 1915), and CPGRAMS.</p>
        </div>
      </div>
    </div>
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 4 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""

print('Page 3 and Page 4 defined.')
...
page5_html = f"""
  <div class="report-page">
    <div class="page-body">
      ...
      <!-- SECTION 3 Part 3 -->
      <div class="sec-title"><span class="sec-icon">🔄</span> 3. Technical Approach — 5-Stage Implementation Methodology</div>
      <p>
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 5 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""
  ...
  <div class="report-page">
    <div class="page-body">
      ...
      <table>
        <thead>
          <tr>
            <th style="width: 27%;">Operational Challenge & Risk</th>
            <th style="width: 33%;">Potential Impact</th>
            <th style="width: 40%;">Mitigation Strategy Implemented in Label Lens AI</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <td><strong>1. Optical Degradation & Glare</strong><br><span style="color:#64748B;">Metallic foil pouches, curved cans, wrinkled plastic pouches</span></td>
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 6 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""

print('Page 5 and Page 6 defined.')
...
page7_html = f"""
  <div class="report-page">
    <div class="page-body">
      ...
      <!-- SECTION 5 Part 1 -->
      <div class="sec-title"><span class="sec-icon">📈</span> 5. Impact and Benefits — Target Audience & Strategic Outcomes</div>
      <p>
      ...
      <div class="sub-title">Strategic Outcome Metrics & Return on Investment</div>
      <div class="figure-box">
        <img src="{impact_diagram}" alt="Impact & Benefits Infographic" />
        <div class="figure-caption">Figure 5.1: Quantifiable Impact and Strategic Benefits across Social, Economic, Administrative, and Environmental Dimensions</div>
      </div>
    </div>
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 7 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""
...
page8_html = f"""
  <div class="report-page">
    <div class="page-body">
      ...
      <!-- SECTION 5 Part 2 -->
      <div class="sec-title"><span class="sec-icon">🌱</span> 5. Impact and Benefits — Multi-Pillar Dimension Analysis</div>
      <p>
        The benefits of nationwide Label Lens AI deployment extend across four fundamental governance and societal pillars:
      </p>

      <div class="card-grid-2">
        <div class="card">
          <div class="card-head"><span>🤝</span> 1. Social Benefits</div>
          <ul>
            <li><strong>Democratization of Consumer Rights:</strong> Bridges the information asymmetry between multi-billion FMCG conglomerates and everyday Indian shoppers.</li>
            <li><strong>Voice-Assisted Rural Inclusion:</strong> Empowers semi-literate citizens to audit packaged commodities using conversational voice guidance in 10 Indian vernacular scripts.</li>
            <li><strong>Restoration of Market Trust:</strong> Rebuilds consumer confidence in retail stores, local kirana networks, and rapid quick-commerce delivery ecosystems.</li>
          </ul>
        </div>

        <div class="card">
          <div class="card-head"><span>📈</span> 2. Economic Benefits</div>
          <ul>
            <li><strong>State Exchequer Penalty Recovery:</strong> Automates compounding penalty calculations under Section 36 of the LMPC Act (₹25,000 for 1st offense, ₹50,000 for repeat offenses), generating substantial revenue.</li>
            <li><strong>Preservation of Consumer Surplus:</strong> Prevents billions of rupees in hidden consumer losses caused by undeclared shrinkflation and misleading pricing.</li>
            <li><strong>Curbing Parallel Illicit Markets:</strong> Drives non-compliant, counterfeit packaging out of circulation, expanding market share for compliant tax-paying businesses.</li>
          </ul>
        </div>

        <div class="card">
          <div class="card-head"><span>🏛️</span> 3. Administrative Benefits</div>
          <ul>
            <li><strong>Zero Defective Grievance Rejections:</strong> Over 40% of consumer complaints on government portals are currently rejected due to incomplete packaging details. Label Lens AI auto-populates all statutory fields, ensuring 100% legally grounded petitions.</li>
            <li><strong>Automated Evidence Compilation:</strong> Generates ready-to-file court dockets containing high-res exhibits, GPS coordinates, and UTC timestamps.</li>
            <li><strong>Centralized Directorate Telemetry:</strong> Macro-intelligence heatmaps identify systemic non-compliance trends across states and brand portfolios.</li>
          </ul>
        </div>

        <div class="card">
          <div class="card-head"><span>🌿</span> 4. Environmental Benefits</div>
          <ul>
            <li><strong>100% Paperless Governance:</strong> Eliminates millions of physical paper inspection forms, challan books, and postal notices across thousands of inspection centers.</li>
            <li><strong>Reduced Inspection Carbon Footprint:</strong> Enables digital pre-inspection, drastically reducing vehicle travel required for physical raids and sample verifications.</li>
            <li><strong>Sustainable Packaging Oversight:</strong> Automates compliance verification for mandatory Plastic Waste Management (PWM) registration numbers and recyclability symbols.</li>
          </ul>
        </div>
      </div>

      <div class="callout callout-green" style="margin-top: 10px;">
        <strong>Quantifiable Transformation:</strong> Slashes inspection turnaround from 25 minutes down to <strong>3.2 seconds (98.4% faster)</strong>, eliminates human bias with <strong>100% court-admissible SHA-256 evidence</strong>, and democratizes consumer safety across <strong>1.4 billion citizens in 10 regional Indian languages</strong>.
      </div>
    </div>
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 8 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""

print('Page 7 and Page 8 defined.')
...
page9_html = f"""
  <div class="report-page">
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 9 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""
  ...
  <div class="report-page">
    <div class="page-body">
      ...
      <div class="callout callout-green" style="margin-top: 8px;">
        <strong>Official Submission Declaration:</strong> Developed and submitted by Team Label Lens for the Smart India Hackathon 2026 (Problem Statement 26034). All referenced prototypes, code repositories, and native APK binaries are fully functional, open-source, and verifiable live.
      </div>
    </div>
    ...
    <div class="doc-footer">
      <div>Smart India Hackathon 2026 — Problem Statement 26034 | Ministry of Consumer Affairs, Food & Public Distribution</div>
      <div>Page 10 of 10 | Official Detailed Project Report</div>
    </div>
  </div>
"""
...
if os.path.exists(pdf_path):
    print(f"SUCCESS: PDF generated ({os.path.getsize(pdf_path)} bytes)")
    
    # Re-render preview pages
    doc = pymupdf.open(pdf_path)
    out_dir = os.path.join(base_dir, "preview_pages")
    os.makedirs(out_dir, exist_ok=True)
    for i in range(len(doc)):
        pix = doc[i].get_pixmap(dpi=150)
        pix.save(os.path.join(out_dir, f"page_{i+1}.png"))
    print(f"Rendered {len(doc)} preview pages to {out_dir}")
else:
